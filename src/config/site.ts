...
export const SEARCH_INDEX = [
  {
    title: 'Home',
    href: '/',
    description: 'OpenCoven landing page and overview of persistent AI familiars.',
  ...
  },
  {
    title: 'How It Works',
    href: '/#how-it-works',
    description: 'Memory, sessions, harnesses, and tools in a live working model.',
  ...
  },
  {
    title: 'Search',
    href: '/search',
    description: 'Search the OpenCoven site and jump to the right page or section.',
